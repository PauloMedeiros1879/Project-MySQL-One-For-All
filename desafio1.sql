...
CREATE TABLE SpotifyClone.artista_seguidor (
...
INSERT INTO SpotifyClone.usuario (id, nome, idade, plano_id, data_de_assinatura)
	VALUES
...
INSERT INTO SpotifyClone.musica (id, titulo, album_id, duracao)
	VALUES
(1, 'Soul For Us', 1, 200),
...
INSERT INTO SpotifyClone.artista_seguidor (usuario_id, artista_id)
VALUES
(1, 1),
(1, 4),
(1, 3),
...
INSERT INTO SpotifyClone.historico_de_reproducao (usuario_id, musica_id, data_de_reproducao)
	VALUES
